...
from financial_ml.features.systematic_default import FirmStructuralCreditRisk, get_systematic_default_probs
...
def test_systematic_default():
    ...
    sys_probs, _, _ = get_systematic_default_probs(datasets_monthly, 1 / 12, firms_data, 0.12)
